 ...
 * @Last Modified time: 2020-04-25 16:13:24
 * @Description: 通用工具
 */


module.exports = function (__runtime__, scope) {
  if (typeof scope.CommonFunctions === 'undefined') {
    scope.CommonFunctions = new CommonFunctions()
  }

  return scope.CommonFunctions
  ...
  function CommonFunctions () {
    ...
    let { config: _config, storage_name: _storage_name } = require('../config.js')(__runtime__, scope)
    let formatDate = require('./DateUtil.js')
    let _runningQueueDispatcher = require('./RunningQueueDispatcher.js')(__runtime__, scope)
    let _FloatyInstance = require('./FloatyUtil.js')(__runtime__, scope)
    let automator = require('./Automator.js')(__runtime__, scope)
    let Timers = require('./Timers.js')(__runtime__, scope)
    let FileUtils = require('./FileUtils.js')(__runtime__, scope)
