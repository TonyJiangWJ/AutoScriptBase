...
function CommonFunctions () {
  ...
  this.setUpAutoStart = function (minutes, forceSetup) {
    ...
    let mainScriptJs = !_config._auto_start_with_main_js ? (() => {
      return engines.myEngine().getSource() + ''
    })() : FileUtils.getRealMainScriptPath()
  ...
  this.cancelAllTimedTasks = function () {
    ...
    if (array && array.length > 0) {
      ...
      let mainScriptJs = _config._auto_start_with_current_engine ? (() => {
        return engines.myEngine().getSource() + ''
      })() : FileUtils.getRealMainScriptPath()
